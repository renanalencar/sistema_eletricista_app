...
/**
 * Generated class for the IniciarServicoElePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-iniciar-servico-ele',
  templateUrl: 'iniciar-servico-ele.html',
})
export class IniciarServicoElePage {
